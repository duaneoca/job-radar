...
const FEATURES: Feature[] = [
  ...
  },
  {
    ...
    body: "Found a role out in the wild? The bookmarklet grabs it straight from LinkedIn, Dice, Indeed, Monster, ZipRecruiter, Built In, Ashby, and Greenhouse — or add one by hand. Duplicates are skipped automatically.",
    points: ["📡 One-click bookmarklet", "Major boards + ATS supported", "Auto-dedupe — no double entries"],
    shot: SHOTS.capture,
